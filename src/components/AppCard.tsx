  ...
  return (
    ...
    >
      <div className="flex items-start justify-between">
        <span className="flex h-14 w-14 items-center justify-center rounded-2xl bg-zinc-100 text-3xl shadow-inner transition-transform duration-300 group-hover:scale-105 dark:bg-zinc-800">
          {app.icon}
        </span>
